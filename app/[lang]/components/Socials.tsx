...
export default function Socials({withEmail}:any){
    return (
        <span className='flex gap-2 pt-3 flex-wrap'>
            ...
            <Tooltip content="@alvaldes_">
                <div className='bg-zinc-900 dark:bg-black rounded-sm w-[21px] h-[21px] mt-[1.5px] ml-0.5 mr-[1.5px] flex items-center justify-center'>
